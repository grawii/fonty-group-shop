...
// 2. ส่วนข้อมูลหมวดหมู่ (วางโค้ด categories ยาวๆ ที่คุณองุ่นเตรียมไว้ตรงนี้)
    ...
    const categories = [
        ...
        { id: 'cat9', name: 'ฟอนต์เครือ GMC', products: [
            ...
            { id: 'kr6', name: 'ลูน่าโดริ (Kirakira LunaDori)', price: 159, detail: 'รวมชพณ.', img: 'https://img1.pic.in.th/images/0986b723c30a55f70acfe4d40ecb2530.png', tags: ['ฟอนต์เนื้อหา'] },
            { id: 'kr7', name: 'ลูน่าเฟลิ (Kirakira LunaFeli)', price: 159, detail: 'รวมชพณ.', img: 'https://img2.pic.in.th/586ae74eaca6f8408e256c738b7bdf10.png', tags: ['ฟอนต์เนื้อหา'] },
            { id: 'kr8', name: 'ลูน่าเซลิ (Kirakira LunaSeli)', price: 159, detail: 'รวมชพณ.', img: 'https://img1.pic.in.th/images/cac6d3f9ec2d1ca9a5662f2151f1388e.png', tags: ['ฟอนต์เนื้อหา'] },
            { id: 'kr9', name: 'ลูน่าเอลญ่า (Kirakira LunaElya)', price: 159, detail: 'รวมชพณ.', img: 'https://img2.pic.in.th/5f3ea91901709341f424b5685eec0752.png', tags: ['ฟอนต์เนื้อหา'] },
            { id: 'kr10 ', name: 'ลูน่าเจมิ (Kirakira LunaJemi)', price: 159, detail: 'รวมชพณ.', img: 'https://img2.pic.in.th/59c961764e60f6797ddf90836d45ef1d.png', tags: ['ฟอนต์เนื้อหา'] }
        ]},
		    { id: 'cat11', name: 'ฟอนต์เครือ Potato', products: [
            { id: 'ptt1', name: 'Tomato (Potato Tomato)', price: 129, detail: 'มีแค่ภาษาอังกฤษ', isRecommend : true, badge: {text: 'Recommend', type: 'red'}, img: 'https://img1.pic.in.th/images/IMG_27485de7f768a18a1304.jpeg', tags: ['ฟอนต์หัวข้อ'] },
            { id: 'ptt2', name: 'Cloud (Potato Cloud)', price: 129, detail: 'มีแค่ภาษาอังกฤษ', badge: {text: 'Recommend', type: 'red'}, img: 'https://img1.pic.in.th/images/IMG_2746b5bf71975be29800.jpeg', tags: ['ฟอนต์หัวข้อ'] },
            { id: 'ptt3', name: 'Doggy (Potato Doggy)', price: 99, oldPrice: 129, detail: 'มีแค่ภาษาอังกฤษ', img: 'https://img1.pic.in.th/images/IMG_2752ad98020482ba9993.jpeg', tags: ['ฟอนต์หัวข้อ'] },
            ...
            { id: 'ptt11', name: 'โมจิ (Potato Mochi)', price: 69, detail: 'ราคารวมใช้งานส่วนตัวและเชิงพาณิชย์', img: ['https://img2.pic.in.th/07D79EF9-75BE-4963-8C30-DAA5BBBAA9D8.jpeg','https://img1.pic.in.th/images/2315C1FB-B256-4332-B40E-89B519721BAD.jpeg'], tags: ['ฟอนต์เนื้อหา'] },
            ...
            { id: 'ptt19', name: 'Apple (Potato Apple)', price: 99, oldPrice: 129, detail: 'มีแค่ภาษาอังกฤษ', img: ['https://img2.pic.in.th/071BD79F-D153-48BE-834C-02F87073E0E6.jpeg','https://img2.pic.in.th/595807AC-DEFF-46E7-A3DB-F7DB8A36EC6B.jpeg'], tags: ['ฟอนต์หัวข้อ'] },
